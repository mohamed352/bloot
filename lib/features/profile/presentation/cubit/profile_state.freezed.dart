...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( UserProfile profile,  List<GameHistory> gameHistory,  List<Achievement> achievements)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ProfileInitial() when initial != null:
return initial();case ProfileLoading() when loading != null:
return loading();case ProfileLoaded() when loaded != null:
return loaded(_that.profile,_that.gameHistory,_that.achievements);case ProfileError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( UserProfile profile,  List<GameHistory> gameHistory,  List<Achievement> achievements)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case ProfileInitial():
return initial();case ProfileLoading():
return loading();case ProfileLoaded():
return loaded(_that.profile,_that.gameHistory,_that.achievements);case ProfileError():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( UserProfile profile,  List<GameHistory> gameHistory,  List<Achievement> achievements)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case ProfileInitial() when initial != null:
return initial();case ProfileLoading() when loading != null:
return loading();case ProfileLoaded() when loaded != null:
...
class ProfileLoaded implements ProfileState {
  const ProfileLoaded({required this.profile, final  List<GameHistory> gameHistory = const [], final  List<Achievement> achievements = const []}): _gameHistory = gameHistory,_achievements = achievements;
  

 final  UserProfile profile;
 final  List<GameHistory> _gameHistory;
@JsonKey() List<GameHistory> get gameHistory {
...
@JsonKey() List<Achievement> get achievements {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileLoaded&&(identical(other.profile, profile) || other.profile == profile)&&const DeepCollectionEquality().equals(other._gameHistory, _gameHistory)&&const DeepCollectionEquality().equals(other._achievements, _achievements));
}


@override
int get hashCode => Object.hash(runtimeType,profile,const DeepCollectionEquality().hash(_gameHistory),const DeepCollectionEquality().hash(_achievements));

@override
String toString() {
  return 'ProfileState.loaded(profile: $profile, gameHistory: $gameHistory, achievements: $achievements)';
}
...
@useResult
$Res call({
 UserProfile profile, List<GameHistory> gameHistory, List<Achievement> achievements
});
...
/// Create a copy of ProfileState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? profile = null,Object? gameHistory = null,Object? achievements = null,}) {
  return _then(ProfileLoaded(
profile: null == profile ? _self.profile : profile // ignore: cast_nullable_to_non_nullable
as UserProfile,gameHistory: null == gameHistory ? _self._gameHistory : gameHistory // ignore: cast_nullable_to_non_nullable
as List<GameHistory>,achievements: null == achievements ? _self._achievements : achievements // ignore: cast_nullable_to_non_nullable
as List<Achievement>,
  ));
}
