...
@useResult
$Res call({
 String id, List<GamePlayerModel> players, List<String> myHand, int mySeatIndex, List<String?> playedCards, int scoreUs, int scoreThem, int teamAScore, int teamBScore, String trump, String status, int turnIndex, int currentRound, int targetScore, String? gameType, int dealerIndex, String? faceUpCard, String? biddingTeam, String? fellTeam, TrickModel? currentTrick, String? roomId, String? agoraChannelName, bool voiceEnabled, bool cameraEnabled, Map<String, dynamic>? engineState
});
...
as bool,engineState: freezed == engineState ? _self.engineState : engineState // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  List<GamePlayerModel> players,  List<String> myHand,  int mySeatIndex,  List<String?> playedCards,  int scoreUs,  int scoreThem,  int teamAScore,  int teamBScore,  String trump,  String status,  int turnIndex,  int currentRound,  int targetScore,  String? gameType,  int dealerIndex,  String? faceUpCard,  String? biddingTeam,  String? fellTeam,  TrickModel? currentTrick,  String? roomId,  String? agoraChannelName,  bool voiceEnabled,  bool cameraEnabled,  Map<String, dynamic>? engineState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameModel() when $default != null:
return $default(_that.id,_that.players,_that.myHand,_that.mySeatIndex,_that.playedCards,_that.scoreUs,_that.scoreThem,_that.teamAScore,_that.teamBScore,_that.trump,_that.status,_that.turnIndex,_that.currentRound,_that.targetScore,_that.gameType,_that.dealerIndex,_that.faceUpCard,_that.biddingTeam,_that.fellTeam,_that.currentTrick,_that.roomId,_that.agoraChannelName,_that.voiceEnabled,_that.cameraEnabled,_that.engineState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  List<GamePlayerModel> players,  List<String> myHand,  int mySeatIndex,  List<String?> playedCards,  int scoreUs,  int scoreThem,  int teamAScore,  int teamBScore,  String trump,  String status,  int turnIndex,  int currentRound,  int targetScore,  String? gameType,  int dealerIndex,  String? faceUpCard,  String? biddingTeam,  String? fellTeam,  TrickModel? currentTrick,  String? roomId,  String? agoraChannelName,  bool voiceEnabled,  bool cameraEnabled,  Map<String, dynamic>? engineState)  $default,) {final _that = this;
switch (_that) {
case _GameModel():
return $default(_that.id,_that.players,_that.myHand,_that.mySeatIndex,_that.playedCards,_that.scoreUs,_that.scoreThem,_that.teamAScore,_that.teamBScore,_that.trump,_that.status,_that.turnIndex,_that.currentRound,_that.targetScore,_that.gameType,_that.dealerIndex,_that.faceUpCard,_that.biddingTeam,_that.fellTeam,_that.currentTrick,_that.roomId,_that.agoraChannelName,_that.voiceEnabled,_that.cameraEnabled,_that.engineState);case _:
  throw StateError('Unexpected subclass');
...
as String?,voiceEnabled: null == voiceEnabled ? _self.voiceEnabled : voiceEnabled // ignore: cast_nullable_to_non_nullable
as bool,cameraEnabled: null == cameraEnabled ? _self.cameraEnabled : cameraEnabled // ignore: cast_nullable_to_non_nullable
as bool,engineState: freezed == engineState ? _self._engineState : engineState // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
