...
(function () {
  ...
  const sfx = {
    card() { tone(1800, 0.05, "triangle", 0.08); tone(900, 0.07, "sine", 0.05, 0.02); },
    trick() { tone(523, 0.1, "sine", 0.12); tone(784, 0.15, "sine", 0.12, 0.08); },
    deal() { for (let i = 0; i < 4; i++) tone(1200 + i * 150, 0.04, "triangle", 0.06, i * 0.06); },
    win() { [523, 659, 784, 1047].forEach((f, i) => tone(f, 0.25, "sine", 0.15, i * 0.13)); },
    lose() { [400, 350, 300].forEach((f, i) => tone(f, 0.3, "sine", 0.12, i * 0.15)); },
    turn() { tone(880, 0.08, "sine", 0.1); },
    project() { tone(659, 0.12, "sine", 0.12); tone(988, 0.18, "sine", 0.12, 0.1); },
    eeka() { tone(1046, 0.09, "triangle", 0.13); tone(1568, 0.14, "triangle", 0.13, 0.07); },
  };
  ...
  window.BalootVoice = { speak, sfx, settings, setVoice, setSfx };
})();
